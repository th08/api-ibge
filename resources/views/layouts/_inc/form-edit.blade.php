            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select name="estado_id" id="select-state" class="form-control">
                        ...
                        <option value="{{isset($estado->id ) ? $estado->id : old('estado_id')}}" {{$estado->id === $registro->estado_id ? "selected" : ''}}>{{isset($estado->nomeEstado) ? $estado->nomeEstado : ''}}</option>                        
                        @endforeach                      
                    </select>
                </div>
            </div>
